...
public class Constants {
    ...
    public static final String F_SERIES = "series";
    ...
    public static void TextQuerySorting(TextQuery textQuery, String field1, boolean isAscending1, String field2,
            boolean isAscending2) {
    ...
    public static void QuerySorting(Query textQuery, String field1, boolean isAscending1, String field2,
            boolean isAscending2) {
        Sort.Order order1 = new Sort.Order(isAscending1 ? Sort.Direction.ASC : Sort.Direction.DESC, field1);
        Sort.Order order2 = new Sort.Order(isAscending2 ? Sort.Direction.ASC : Sort.Direction.DESC, field2);
        textQuery.with(Sort.by(order1, order2));
