...
public class RestControllerDragonballzfw {
    ...
    @PostMapping("/qr")
    public ResponseEntity<List<DragonBallzFWCard>> setCardListService(@RequestBody String value) {
        return new ResponseEntity<List<DragonBallzFWCard>>(cardListService.listofdragonballzfw().deckExtract(value),
                HttpStatus.OK);
    }
