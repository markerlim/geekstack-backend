...
public class CardPriceFULLA {
    ...
    public CardPriceFULLA(){

    }

    public CardPriceFULLA(ObjectId id, float pricejpy, String rarity, String cardcode, int stock, String url,
            String animecode, String priceFullaId, Map<String, List<PriceData>> pricedata) {
        this.id = id;
